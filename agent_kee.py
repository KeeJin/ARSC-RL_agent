AGENT_NAME                  =       "agent_kee"
TEAM_NAME                   =       "monk"

    
# These are algorithm parameters. You need to change this
DELTA                       =      0.02              #   How much should the epsilon shift by in every game
LR                          =      0.25            #   This is the learning rate. High learning rate means faster learning"                     
GAMMA                       =      0.25              #   gamma = discount factor. High gamma value means focus on future rewards "
...
TAKE_DAMAGE                 =      -500     
EARN_AMMO                   =      100
COLLIDE_WITH_WALLS          =      -50
DAMAGE_ITSELF               =      -500        
NO_DESTRUCTION              =      -10                 
NO_KILL                     =      -20             
PLACING_BOMBS_WITH_NO_AMMO  =      -100
BOMB_IN_RANGE               =      -400
PLACING_BOMB_ON_TOP_OF_BOMB =      -100
EXIST_PENALTY               =      0
...
class Agent:
    ...
    def next_move(self, game_state, player_state):
        ...
        if(done):
            ...
            if(player_state.hp==0):     print(AGENT_NAME+" LOST")
            else:                       print(AGENT_NAME+" WON")
